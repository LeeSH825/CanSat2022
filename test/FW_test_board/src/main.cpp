...
if (accelgyro.dmpGetCurrentFIFOPacket(fifoBuffer)) { // Get the Latest packet 
	...
	temp.accel_x = aaReal.x;
	temp.accel_y = aaReal.y;
	temp.accel_z = aaReal.z;
	temp.gyro_x = ypr[0]* 180/M_PI;
	temp.gyro_y = ypr[1]* 180/M_PI;
	temp.gyro_z = ypr[2]* 180/M_PI;
// FROM MPU6050
...
//   setRF_Mode('t');
  ...
  // join I2C bus (I2Cdev library doesn't do this automatically)
	...
	// set OFFSET
	accelgyro.setXAccelOffset(-6509);
	accelgyro.setYAccelOffset(-743);
	accelgyro.setZAccelOffset(1403);
