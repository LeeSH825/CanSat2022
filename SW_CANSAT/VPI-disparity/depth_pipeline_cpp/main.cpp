...
int main(int argc, char *argv[])
{
    ...
    // Image params
    int32_t W_input  = 1640;
    int32_t H_input  = 1232;
    int32_t W_stereo  = 1640;
    int32_t H_stereo = 1232;
    int32_t FPS = 30;
    ...
    CHECK_STATUS(vpiImageCreateWrapperOpenCVMat(cvImageLeft, 0, &imgL));
    CHECK_STATUS(vpiImageCreateWrapperOpenCVMat(cvImageRight, 0, &imgR));
